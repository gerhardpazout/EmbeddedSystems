...
public class CommandLine implements ICommandLine, Runnable {

    private Config config;
    private Shell shell;
    private String loggedInUser = null;

    public CommandLine(String componentId, Config config, InputStream inputStream, PrintStream outputStream) {
        this.config = config;
